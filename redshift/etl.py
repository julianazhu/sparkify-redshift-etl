"""
This module imports data song and log data from .json files in AWS S3 buckets
into the Redshift cluster DB.
"""
import psycopg2
import redshift.helpers as helpers
from redshift.queries import copy_table_queries, insert_table_queries
